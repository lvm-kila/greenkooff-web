  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-black/85 backdrop-blur">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 text-white md:px-8">
        <a href="#inicio" className="text-2xl font-black tracking-wide text-emerald-500">
          Greenkooff
        </a>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-bold shadow-lg shadow-emerald-900/40 transition hover:scale-105 hover:bg-emerald-500"
        >
          Pedir por WhatsApp
        </a>
      </nav>
