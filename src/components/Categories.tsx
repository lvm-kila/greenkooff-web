  ...
  return (
    <section id="menu" className="bg-white py-16">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <p className="text-sm font-bold uppercase tracking-widest text-red-600">Menú por categoría</p>
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button className="mt-3 rounded-xl bg-zinc-900 px-4 py-2 text-sm font-bold text-white transition hover:bg-red-600">
                  Ver más
                </button>
              </div>
            </article>
