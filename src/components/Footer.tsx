  ...
  return (
    <footer className="bg-black py-10 text-zinc-300">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 md:grid-cols-3 md:px-8">
        <div>
          <p className="text-2xl font-black text-red-500">Greenkooff</p>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            <li>
              <a href="#inicio" className="hover:text-red-400">
                Inicio
              </a>
            </li>
            <li>
              <a href="#promociones" className="hover:text-red-400">
                Promociones
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#ubicacion" className="hover:text-red-400">
                Ubicación
              </a>
            </li>
          </ul>
